...
//
$GLOBALS['Lang']['PW_DOC_POPUP']          = 'Online documentation';
$GLOBALS['Lang']['PW_EXCLAIM']            = '!';
$GLOBALS['Lang']['PW_HELP_LINK']          = '?';
$GLOBALS['Lang']['PW_ITEM_MARKER']        = ':';
$GLOBALS['Lang']['PW_REQUIRED']           = '*';
$GLOBALS['Lang']['PW_REQUIRED_NOTE']      = 'Required Information';
$GLOBALS['Lang']['PW_LINK_EXTEND']        = '...';
$GLOBALS['Lang']['PW_PAGE_GENERATED']     = 'Page generated in';
$GLOBALS['Lang']['PW_PAGE_GENERATED_SEC'] = 'seconds.';
$GLOBALS['Lang']['PW_SCRIPT_WARN']        = 'This site requires the use of client side scripting and cookies. Please enable scripting and cookies in your browser preferences.';
