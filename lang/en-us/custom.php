...
# Name: custom.php
#
# Method: called from the global language files
#
# Description: sets the custome marker variables used in the template files
#
###########################################################################
...
//
$GLOBALS['Lang']['PW_CUSTOM_'] = 'custom value';
