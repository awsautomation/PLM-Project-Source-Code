...
CREATE TABLE {DATABASE_PREFIX}history
(
    tsid BIGINT(16) UNSIGNED NOT NULL,
    datestamp DATETIME,
    userid BIGINT(50) UNSIGNED NOT NULL,
    modification CHAR(255) NOT NULL,
    PRIMARY KEY (tsid)
);