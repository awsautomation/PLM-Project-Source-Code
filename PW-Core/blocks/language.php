...
include_once(PWCORE_DIRECTORY . LANG_DIRECTORY . LANG_DEFAULT . '/languages' . FILE_EXTENSION);
...
//
$GLOBALS['TemplateFiles'][] = PWCORE_DIRECTORY . TEMPLATE_PATH . 'block_language.tpl';
